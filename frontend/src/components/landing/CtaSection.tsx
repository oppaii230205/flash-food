      ...
      <div className="max-w-6xl mx-auto px-5">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle,rgba(82,183,136,.18) 0%,transparent 65%)",
            }}
          />

          <div className="relative z-10">
            <div className="flex justify-center mb-4">
              <Leaf size={52} weight="duotone" className="text-green-400" />
            </div>
            ...
            <p className="text-green-300 text-base mb-8 max-w-md mx-auto">
              Download the app or sign up online — save up to 70%&nbsp;on
              delicious surplus food tonight.
            </p>

            {/* App store buttons */}
            <div className="flex flex-wrap gap-3 justify-center mb-6">
              {[
                { Icon: AppleLogo, sub: "Download on the", label: "App Store" },
                {
                  Icon: GooglePlayLogo,
                  sub: "Get it on",
                  label: "Google Play",
                ...
                >
                  ...
                  <span className="text-left">
                    <span className="block text-[0.64rem] font-medium opacity-75">
                      {sub}
                    </span>
                    {label}
                  </span>
            ...
            {isAuthenticated ? (
              <Link to="/deals">
                <Button size="lg" className="mx-auto">
                  Go to Tonight's Deals ↗
                </Button>
              </Link>
            ) : (
              <form
                onSubmit={handleSubmit}
                className="flex gap-2 max-w-sm mx-auto flex-wrap justify-center"
              >
                <input
                  type="email"
                  value={email}
            ...
            <div className="flex flex-wrap gap-3 justify-center mt-7">
              {[
                ...
                },
                {
                  ...
                  label: "1 tree planted per signup",
                },
                {
                ...
                <span
                  key={label}
                  className="flex items-center gap-1.5 bg-white/8 rounded-full px-3.5 py-1.5 text-[0.77rem] text-green-200 font-semibold"
                >
                  {icon} {label}
                </span>
              ))}
